...
void Transformer::create_dot_source( std::ostream &os, const SyntaxTree &grammar )
{
    DotVisitor printer( os );
    grammar.accept( printer );
}

void Transformer::create_svg_image( std::string filename, const SyntaxTree& grammar )
{
