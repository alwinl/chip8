/*
 * ebnf_jsonprinter.h Copyright 2026 Alwin Leerling dna.leerling@gmail.com
 *
...
struct JSONPrintVisitor : ASTVisitor
{
    JSONPrintVisitor( std::ostream& os ) : os(os) {};
	...
	bool parsing_alternate_parts = false;
};
