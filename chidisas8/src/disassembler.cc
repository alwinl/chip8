...
void Disassembler::disassemble( uint16_t start_address )
{
	process_list.push( start_address );		// push the start address
...
void Disassembler::disassemble( std::istream& is )
{
	uint16_t address = 0x200;
	uint8_t ch = is.get();
